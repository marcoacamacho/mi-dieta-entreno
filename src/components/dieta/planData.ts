...
export const MEAL_PLAN: DayPlan[] = [
  ...
  },
  {
    ...
    meals: [
      ...
      {
        id: "dom-libre",
        nombre: "Día de descarga dietética — sube algo los carbohidratos, mantén la proteína y disfruta sin culpa",
        kcal: 0,
        proteina: 0,
        ingredientes: [],
        momento: "libre",
